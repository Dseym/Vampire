...
public class UConf extends Entity<UConf>
{
	...
	public Map<EntityType, Double> entityTypeFullFoodQuotient = MUtil.map(
		...
		EntityType.CAT, 5/20D,
		EntityType.RABBIT, 5/20D,
		EntityType.FOX, 5/20D,
		EntityType.SALMON, 2/20D,
		EntityType.PARROT, 5/20D,
		EntityType.WANDERING_TRADER, 10/20D,
		EntityType.COD, 2/20D,
		EntityType.TROPICAL_FISH, 2/20D,
		EntityType.TURTLE, 10/20D,
		EntityType.POLAR_BEAR, 10/20D,
		EntityType.DOLPHIN, 5/20D,
		EntityType.PIG_ZOMBIE, 20/20D,
		EntityType.PUFFERFISH, 5/20D,
		EntityType.LLAMA, 10/20D,
		EntityType.TRADER_LLAMA, 10/20D,
		EntityType.PANDA, 10/20D,
		EntityType.BEE, 5/20D,
		EntityType.PHANTOM, 5/20D
	);
	...
	public List<ItemStack> holyWaterResources = MUtil.list(
		...
		new ItemStack(Material.INK_SAC, 1, (short)4)
	);
